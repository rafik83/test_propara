...
class EmailService2 extends ContainerAware {
...
//               $email = 'turki@intersa.fr';
     ...
     public function getHtmlBulletin(Salary $salary,$mois, $annee)
     {
         ...
         $email = $salary->getEmailPerso();//$salary->getEmailPerso();//'turki@intersa.fr'
         if (is_null($email)) {
             $email = $salary->getEmailPro();
//             $email = 'turki@intersa.fr';
         }
...
//        foreach ($list1p as $key => $value) {
////            $sal = $value->get
//            if ($value->getNom() =='FERRAN') {
//                $mat = $value->getMatricule();
//                var_dump("matricule FERRAN");
//                var_dump($mat);
////                 die('matri');
//            }
//        }
