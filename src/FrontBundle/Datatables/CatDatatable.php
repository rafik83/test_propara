...
class CatDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = array())
    {
        ...
        $this->ajax->set(array(
            "url" => $this->router->generate("front_cats_result"),
            "type" => "GET"
        ));
        ...
        $this->columnBuilder
            ...
            ->add("libelle", "column", array("title" => "Libelle",))
